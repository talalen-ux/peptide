  ...
  return (
    <div className="relative" style={{ width: 220, height: 260 }}>
      ...
      >
        ...
        <path d="M24 6 L24 28 L6 66 Q6 76 16 76 L48 76 Q58 76 58 66 L40 28 L40 6" stroke="#c4e233" strokeWidth="2" strokeLinejoin="round" fill="#c4e233" fillOpacity="0.04" />
        <path d="M10 52 Q20 46 32 52 Q44 58 54 52 L58 66 Q58 76 48 76 L16 76 Q6 76 6 66 Z" fill="#c4e233" fillOpacity="0.3" style={{ animation: "slosh 3s ease-in-out infinite" }} />
        <path d="M10 56 Q22 50 32 56 Q42 62 54 56 L58 66 Q58 76 48 76 L16 76 Q6 76 6 66 Z" fill="#c4e233" fillOpacity="0.65" style={{ animation: "slosh-front 3s ease-in-out infinite" }} />
        <path d="M8 64 L56 64 Q58 76 48 76 L16 76 Q6 76 8 64 Z" fill="#c4e233" fillOpacity="0.85" />
        <circle cx="22" cy="68" r="2.5" fill="#060a0c" fillOpacity="0.3" style={{ animation: "bubble-rise 2.8s ease-in infinite" }} />
        <circle cx="36" cy="70" r="1.8" fill="#060a0c" fillOpacity="0.25" style={{ animation: "bubble-rise-slow 3.5s ease-in infinite", animationDelay: "-1.2s" }} />
        <circle cx="28" cy="72" r="1.5" fill="#060a0c" fillOpacity="0.2" style={{ animation: "bubble-rise 4s ease-in infinite", animationDelay: "-2s" }} />
        <circle cx="42" cy="69" r="2" fill="#060a0c" fillOpacity="0.25" style={{ animation: "bubble-rise-slow 3s ease-in infinite", animationDelay: "-0.5s" }} />
        <circle cx="18" cy="71" r="1.2" fill="#060a0c" fillOpacity="0.2" style={{ animation: "bubble-rise 3.2s ease-in infinite", animationDelay: "-1.8s" }} />
      ...
      <div className="absolute bottom-0 left-1/2 -translate-x-1/2 w-40 h-8 rounded-full opacity-20 blur-xl" style={{ background: "#c4e233" }} />
    </div>
  );
}
...
export default function LandingPage() {
  return (
    <div className="min-h-[calc(100vh-44px)] flex flex-col items-center justify-center px-6 relative overflow-hidden">
      ...
      <div style={{ animation: "fade-in-up 0.8s ease-out 0.3s both" }}>
        <p className="text-center text-[15px] max-w-md leading-[1.75] mt-6">
          <span className="inline bg-[var(--bg)]/80 px-1.5 py-0.5 rounded text-[var(--text-secondary)]">
            Tokenized scientific intelligence.
          </span>
          <br className="hidden sm:block" />
          <span className="inline bg-[var(--bg)]/80 px-1.5 py-0.5 rounded text-[var(--text-muted)] text-[13px]">
            Global participation, transparent funding, open coordination,
            and liquid exposure to scientific innovation.
          </span>
        </p>
      </div>
      ...
      <div
        className="flex items-center gap-4 sm:gap-6 flex-wrap justify-center font-mono text-[10px] mt-14"
        style={{ animation: "fade-in-up 0.8s ease-out 0.6s both" }}
      >
        <span className="bg-[var(--bg)]/80 px-1.5 py-0.5 rounded text-[var(--text-muted)]">
          <span className="text-[var(--text-secondary)]">6</span> agents
        </span>
        <span className="text-[var(--border-hover)]">·</span>
        <span className="bg-[var(--bg)]/80 px-1.5 py-0.5 rounded text-[var(--text-muted)]">
          <span className="text-[var(--text-secondary)]">5</span> pods
        </span>
        <span className="text-[var(--border-hover)]">·</span>
        <span className="bg-[var(--bg)]/80 px-1.5 py-0.5 rounded text-[var(--text-muted)]">
          <span className="text-[var(--text-secondary)]">$100k</span> funded
        </span>
        <span className="text-[var(--border-hover)]">·</span>
        <span className="bg-[var(--bg)]/80 px-1.5 py-0.5 rounded text-[var(--text-muted)]">
          <span className="text-[var(--text-secondary)]">7.6</span> ETH earned
        </span>
      </div>
